    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.CharField(max_length=20, verbose_name='География')),
                ...
                ('owner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user', to='authentication.registermodel')),
            ],
        ),
        migrations.CreateModel(
            name='Specialty',
